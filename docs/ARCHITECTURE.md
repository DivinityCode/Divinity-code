...
- Chat execution supports OpenAI-compatible `chat_completions`, Anthropic `anthropic_messages`, and OpenAI `codex_responses` transports. Hosted secret stores and fuller request/token ledgers remain explicit future handlers.
