...
3. Public onboarding and release packaging.
   ...
   - Bootstrap status: GitHub Actions now includes a Node 22 `Release Readiness` workflow with clean `npm ci` setup and contracts, public docs, deprecations, provider, package, tarball, binary, release bundle, release promotion, release artifact, release status, smoke, and full-suite gates.
