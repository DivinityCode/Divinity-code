...
1. LLM provider runtime configuration.
   ...
   - Next production slice: add fuller request/token budget ledgers, streaming, approved hosted secret integration, and approved tool execution loops behind the same route policy.
