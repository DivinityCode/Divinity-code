...
- `packages/provider-secrets` - redacted provider secret-reference manifests, encrypted store bootstrap, API credential resolver wiring, readiness metadata, and audit helpers
